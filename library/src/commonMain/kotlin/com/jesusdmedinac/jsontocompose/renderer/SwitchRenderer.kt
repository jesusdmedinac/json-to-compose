...
fun ComposeNode.ToSwitch() {
    ...
    if (checkedStateHostName == null) {
        println("Warning: Switch node has no checkedStateHostName. The component will not render.")
        return
    }

    val enabledStateHostName = props.enabledStateHostName
    if (enabledStateHostName == null) {
        println("Warning: Switch node has no enabledStateHostName. The component will not render.")
        return
    }

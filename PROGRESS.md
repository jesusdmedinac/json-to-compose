...
| 4   | [phase-3-expand-library](#4-phase-3-expand-library)               | `library/`    | 239       | 140       | **59%**  |
...
| ModalBottomSheet | 10 | ModalBottomSheet with state, drag, shape, scrim | 🏗️ In Progress (7/10) |
